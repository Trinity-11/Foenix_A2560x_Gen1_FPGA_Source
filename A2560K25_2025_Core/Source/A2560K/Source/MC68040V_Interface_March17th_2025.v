...
// FLASH
// Flash Management
assign Flash_OE 				= (!DTACK & FLASH0) | (  Wait_FLASH_TA_i[2] & FLASH0 ) | (  Wait_FLASH_TA_i[1] & FLASH0 ) | (  Wait_FLASH_TA_i[0] & FLASH0 );
...
assign CS_None_Cacheable 		= ( CS_GABE | CS_BEATRIX | CS_VICKY_A | CS_VICKY_MEM_A | CS_VICKY_B | CS_VICKY_MEM_B | CS_VRAM_A | CS_VRAM_B | CS_MERA);wire UserData;
