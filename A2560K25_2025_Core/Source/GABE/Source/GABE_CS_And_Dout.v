...
input		wire	[31:0]	DataOut_WS5500_i,					//x1
...
output   wire  			CS_WS5500_o,				// External WS5500 Network Module (Plugged in Joystick 0)
...
assign CS_WS5500_o				= ( iBUS_A_i[16:8] == 9'b0_0000_1010) & iBUS_CS_GABE_i;						// $FEC00A00..$FEC00AFF - WS5500
...
wire [12:0] CS_Combined;

assign CS_Combined 	= ( { CS_MATH_FLOAT_o, CS_MATH_FIXED_o, CS_LPC_o, CS_WS5500_o, CS_NIC_o, CS_Joystick_o, CS_IDE_o, CS_SDCard_o, CS_Timer_o, CS_Interrupt_Ctrl_o, CS_RTC_o, CS_A2560K_KB_o, CS_GABE_Config_o });

always @ (*) begin
	case (CS_Combined)
		13'b0_0000_0000_0000: begin DataOut_o = 32'hDEAD_BEEF; 					end
		13'b0_0000_0000_0001: begin DataOut_o = DataOut_GABE_Config_i; 		end
		13'b0_0000_0000_0010: begin DataOut_o = DataOut_A2560K_KB_i; 			end		
		13'b0_0000_0000_0100: begin DataOut_o = DataOut_RTC_i; 					end
		13'b0_0000_0000_1000: begin DataOut_o = DataOut_Interrupt_Ctrl_i;		end
		13'b0_0000_0001_0000: begin DataOut_o = DataOut_Timer_i; 				end
		13'b0_0000_0010_0000: begin DataOut_o = DataOut_SDCARD_CTRL_i; 		end
		13'b0_0000_0100_0000: begin DataOut_o = DataOut_IDE_ETH_DPS_i; 		end
		13'b0_0000_1000_0000: begin DataOut_o = DataOut_Joystick_i; 			end
		13'b0_0001_0000_0000: begin DataOut_o = DataOut_IDE_ETH_DPS_i; 		end
		13'b0_0010_0000_0000: begin DataOut_o = DataOut_WS5500_i; 				end
		13'b0_0100_0000_0000: begin DataOut_o = DataOut_LPC_Interface_i;		end
		13'b0_1000_0000_0000: begin DataOut_o = DataOut_Math_Fixed_i; 			end
		13'b1_0000_0000_0000: begin DataOut_o = DataOut_Math_Float_i; 			end
