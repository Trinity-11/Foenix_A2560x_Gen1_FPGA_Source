...
output	wire				RAM_CSn_Lo_o,
output	wire				RAM_CSn_Hi_o,
...
assign Flash_CS_Hi_o 			= Flash_CS;
assign Flash_CS_Lo_o				= Flash_CS;
//assign Flash_CS_o					= Flash_CS;
assign Flash_OEn_o 				= Flash_OEn;
assign Flash_WRn_o 				= Flash_WRn;

assign RAM_CSn_Lo_o 				= RAM_CS;
assign RAM_CSn_Hi_o 				= RAM_CS;
