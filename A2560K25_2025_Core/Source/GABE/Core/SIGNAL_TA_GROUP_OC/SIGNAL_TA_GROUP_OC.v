...
module  SIGNAL_TA_GROUP_OC_iobuf_bidir_60p
	( 
	datain,
	dataio,
	dataout,
...
endmodule //SIGNAL_TA_GROUP_OC_iobuf_bidir_60p
//VALID FILE
...
module SIGNAL_TA_GROUP_OC (
	...
	SIGNAL_TA_GROUP_OC_iobuf_bidir_60p	SIGNAL_TA_GROUP_OC_iobuf_bidir_60p_component (
				.datain (datain),
				.oe (oe),
				.dataio (dataio),
				.dataout (sub_wire0));
