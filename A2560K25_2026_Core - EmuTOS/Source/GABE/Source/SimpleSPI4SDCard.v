...
assign TinyTrigger1 = CS_SDCard_i;
...
assign TinyTP1[45]		= CS_SDCard_i;
assign TinyTP1[46]		= CPU_WE_i;
assign TinyTP1[47]		= 1'b0;
assign TinyTP1[51:48]   = CPU_BE_i;
assign TinyTP1[52] 		= F_SD_CLK_o;
assign TinyTP1[53]		= F_SD_DAT0_i; // MISO
assign TinyTP1[54]		= F_SD_CMD_o;	// MOSI
...
/*
reg[2:0]	ReSync_Trigger;

always @ (posedge CPU_2xClk_i)
begin
	ReSync_Trigger[0] <= (CS_SDCard_i & !CPU_R_Wn_i & CPU_Data_Valid_i & CPU_A_i[0]);
	ReSync_Trigger[1] <= ReSync_Trigger[0];
	if ( ReSync_Trigger[1] == ReSync_Trigger[0] ) 
			ReSync_Trigger[2] <= ReSync_Trigger[1];
end 
*/
always @ (posedge CPU_Clk_i)
begin
