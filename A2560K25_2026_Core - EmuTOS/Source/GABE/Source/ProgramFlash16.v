...
input		wire	[23:0]	Org_Flash_Address_i,
...
assign RAM_CS0n_o 				= RAM_CS;
assign RAM_CS1n_o 				= 1'b0;
...
// Byte Write					
localparam		WRITE_DATA0 = 16'h00AA,
					WRITE_DATA1 = 16'h0055,
					WRITE_DATA2 = 16'h00A0;

// Full Erase					
localparam		ERASE_DATA0 = 16'h00AA,
					ERASE_DATA1 = 16'h0055,
					ERASE_DATA2 = 16'h0080,
					ERASE_DATA3 = 16'h00AA,
					ERASE_DATA4 = 16'h0055,
					ERASE_DATA5 = 16'h0010;
...
begin
	...
	case( StateMachine )
		...
		STATE_IDLE: begin
			if (Erase_Flash_i) begin
				...
				if ( Program_Flash_i ) begin
					...
					RAM_CS <= 1'b1;	// Enable RAM - Just control with OE
				end
				else begin
					StateMachine <= STATE_IDLE;
					RAM_OEn		 <= 1'b1;
		...
		STATE_ERASE_ST2: begin
			Addy_Output <=	{ERASE_ADDY2[22:0],1'b0}; //0x5555
		...
		STATE_ERASE_ST3: begin
			Addy_Output <=	{ERASE_ADDY3[22:0],1'b0}; //0x5555
		...
		STATE_ERASE_ST4: begin
			Addy_Output <=	{ERASE_ADDY4[22:0],1'b0}; //0x2AAA
		...
		STATE_ERASE_ST5: begin
			Addy_Output <=	{ERASE_ADDY5[22:0],1'b0}; //0x5555
		...
		STATE_WRITE_BT0: begin
			Flash_CS <= 1'b1;
			ExternBufferDrive <= 1'b0;
			Addy_Output <=	{WRITE_ADDY0[22:0],1'b0}; //0x5555
		...
		STATE_WRITE_BT1: begin
			Addy_Output <=	{WRITE_ADDY1[22:0],1'b0}; //0x2AAA
		...
		STATE_WRITE_BT2: begin
			Addy_Output <=	{WRITE_ADDY2[22:0],1'b0}; //0x5555
...
//			RAM_CS <= 1'b1;
		...
		STATE_PRG_FLASH2:	begin
			ByteCounter <= ByteCounter + 19'b000_0000_0000_0000_0010;	// Increament by 2
		...
		STATE_WRITE_DLY0: begin
			CountDown <= 16'd400;							//14M = 290, 20M = 414, 33M = 683, 40M = 828
