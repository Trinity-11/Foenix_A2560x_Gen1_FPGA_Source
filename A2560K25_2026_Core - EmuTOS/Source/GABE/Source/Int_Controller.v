...
assign TinyTrigger1 = VKY_III_Channel_A_IRQ_i[0];

assign TinyTP1[23:0]  	= CPU_A_i;
assign TinyTP1[39:24] 	= CPU_D32_i;
assign TinyTP1[46:40] 	= iIRQ_Interrupt_o;
assign TinyTP1[47]		= iIRQ_AutoVector_o;
assign TinyTP1[55:48]   = iIRQ_Vector_o;
assign TinyTP1[56] 		= iIRQ_GetVector_i;
assign TinyTP1[62:57]	= VKY_III_Channel_A_IRQ_i;
assign TinyTP1[68:63] 	= VKY_III_Channel_B_IRQ_i;
assign TinyTP1[69]		= Interrupt[0];
assign TinyTP1[70]		= Interrupt_Group[0];
...
/*
			//case(CPU_A_i[4:2])
			//3'b000: begin pending[31:0] 									<= (pending[31:0]  & ~CPU_D32_i); end
			//3'b001: begin { Temp_Reg_Unused[0], pending[47:32]}	<= (pending[47:32] & ~CPU_D32_i); end

			//3'b010: begin pol[31:0] 										<= CPU_D32_i; end
			//3'b011: begin { Temp_Reg_Unused[1], pol[47:32]} 		<= CPU_D32_i; end
			
			//3'b100: begin edgen[31:0] 										<= CPU_D32_i; end
			//3'b101: begin { Temp_Reg_Unused[2], edgen[47:32]} 		<= CPU_D32_i; end
			
			//3'b110: begin mask[31:0] 										<= CPU_D32_i; end
			//3'b111: begin { Temp_Reg_Unused[3], mask[47:32]} 		<= CPU_D32_i; end
			//default: begin end
*/
...
begin
	case(CPU_A_i[4:2])
		3'b000: CPU_D_o = pending[31:0];
		3'b001: CPU_D_o = { Temp_Reg_Unused[0], pending[47:32]};
		3'b010: CPU_D_o = pol[31:0];
		3'b011: CPU_D_o = {Temp_Reg_Unused[1], pol[47:32]};
		3'b100: CPU_D_o = edgen[31:0];
		3'b101: CPU_D_o = {Temp_Reg_Unused[2], edgen[47:32]};
		3'b110: CPU_D_o = mask[31:0];
		3'b111: CPU_D_o = { Temp_Reg_Unused[3], mask[47:32]};
		default: CPU_D_o = 32'hAA55_55AA;		
	endcase
end
*/
...
//	iIRQ_Interrupt_o[0] <= Interrupt_Group[1];
//	iIRQ_Interrupt_o[1] <= Interrupt_Group[0];
//	iIRQ_Interrupt_o[2] <= Interrupt_Group[2];
//	iIRQ_Interrupt_o[3] <= Interrupt_Group[3];
//	iIRQ_Interrupt_o[4] <= Interrupt_Group[4];
//	iIRQ_Interrupt_o[5] <= Interrupt_Group[5];
...
//		7'b000_0001: begin iIRQ_Vector_o		<= 8'H19; end
//		7'b000_001x: begin iIRQ_Vector_o		<= 8'H1A; end
//		7'b000_01xx: begin iIRQ_Vector_o		<= Intr_Group2; end
//		7'b000_1xxx: begin iIRQ_Vector_o		<= Intr_Group3; end
//		7'b001_xxxx: begin iIRQ_Vector_o		<= Intr_Group4; end
//		7'b01x_xxxx: begin iIRQ_Vector_o		<= Intr_Group5; end
//		7'b1xx_xxxx: begin iIRQ_Vector_o		<= 8'h60; end
