...
input 			[15:0]		HBLANK_START_i, 		//1
input 			[15:0]		HBLANK_STOP_i,			//256
...
always @ (*) begin
	case(Mstr_Ctrl_Video_Mode_CPU_i[1:0])
		2'b00: begin Limit_Resolution_X_14Mhz = 16'd640; Limit_Resolution_Y_14Mhz = 16'd480; end
		2'b01: begin Limit_Resolution_X_14Mhz = 16'd640; Limit_Resolution_Y_14Mhz = 16'd400; end
		2'b10: begin Limit_Resolution_X_14Mhz = 16'd800; Limit_Resolution_Y_14Mhz = 16'd600; end
		2'b11: begin Limit_Resolution_X_14Mhz = 16'd800; Limit_Resolution_Y_14Mhz = 16'd600; end
	endcase
end
