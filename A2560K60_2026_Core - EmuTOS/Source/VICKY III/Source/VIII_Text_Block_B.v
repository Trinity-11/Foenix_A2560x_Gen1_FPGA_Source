...
assign Latency						= Mstr_Ctrl_Video_Mode_i[1] ? 16'h0012 : 16'h0009 ;	// changed from 0009 to 0008

assign PreCharge					= Mstr_Ctrl_Video_Mode_i[1] ? 16'h0002 : 16'h0002 ;
...
assign Border_SizeX				= Mstr_Ctrl_Video_Mode_i[1] ? {9'b00_0000_0000, Border_X_Size_i, 1'b0}  		: {10'b00_0000_0000, Border_X_Size_i};
assign Border_SizeY				= Mstr_Ctrl_Video_Mode_i[1] ? {9'b00_0000_0000, Border_Y_Size_i, 1'b0}  		: {10'b00_0000_0000, Border_Y_Size_i};
assign Border_Scroll_X			= Mstr_Ctrl_Video_Mode_i[1] ? {12'b0_0000_0000_0000, Border_X_Scroll_i, 1'b0} : {13'b0_0000_0000_0000, Border_X_Scroll_i};
...
Text_FONT_StateMachine Monochrome_Text_SM(
//Clock and reset
	...
	.FONT_Height_Constant( 6'h08 ),				// 8 or 16 (input [5:0])
...
TEXT_MEM16_BLK	COLOR_MEM16_BLK (
	.clock_a ( CPU_Clk_i ),
	.address_a ( iBUS_A_i[12:0] ),
