...
always @ (*) begin
	case ( { TLayer0Mode8_16_Sync[2], Mstr_Ctrl_Video_Mode_ReSync_Bit1[1] } )
		2'b00: begin TL0Condition2Trigger = ConditionFullClock; 		end
		2'b01: begin TL0Condition2Trigger = ConditionHalfClock; 		end
		2'b10: begin TL0Condition2Trigger = ConditionHalfSizeTiles; end
		2'b11: begin TL0Condition2Trigger = ConditionFullClock; 		end
	endcase
end
always @ (*) begin
	case ( { TLayer1Mode8_16_Sync[2], Mstr_Ctrl_Video_Mode_ReSync_Bit1[1] } )
...
always @ (*) begin
	case ( { TLayer2Mode8_16_Sync[2], Mstr_Ctrl_Video_Mode_ReSync_Bit1[1] } )
...
always @ (*) begin	
	case ( { TLayer3Mode8_16_Sync[2], Mstr_Ctrl_Video_Mode_ReSync_Bit1[1] } )
...
begin
	if (Reset_VideoClk_Full_Resolution || reset_mode) begin
		...
		// First line
		if (VGE_Engine_VBlanking_o && (Visible_Local_Line_Counter == 10'h000)) begin
