...
begin
	...
	// Normal Mode
	3'b000: begin X_Char_Count_Limit = 8'd80;		Y_Char_Count_Limit = 8'd60; end	//640x480@60Hz
	3'b001: begin X_Char_Count_Limit = 8'd80;		Y_Char_Count_Limit = 8'd50; end	//640x400@70Hz
	3'b010: begin X_Char_Count_Limit = 8'd100; 	Y_Char_Count_Limit = 8'd75; end	//800x600@60Hz
	3'b011: begin X_Char_Count_Limit = 8'd100; 	Y_Char_Count_Limit = 8'd75; end	//800x600@60Hz
	// Double Pixel ( Lower Resolution )
	3'b100: begin X_Char_Count_Limit = 8'd40;		Y_Char_Count_Limit = 8'd30; end	//320x240
	3'b101: begin X_Char_Count_Limit = 8'd40;		Y_Char_Count_Limit = 8'd25; end	//320x200
	3'b110: begin X_Char_Count_Limit = 8'd50; 	Y_Char_Count_Limit = 8'd37; end	//400x300
	3'b111: begin X_Char_Count_Limit = 8'd50; 	Y_Char_Count_Limit = 8'd37; end	//400x300
	default: begin end
	endcase
end
...
assign 	ASCII_Text_Addy  	= ASCII_Text_Addy_Ptr[13:0] +  {5'b0_0000, X_Char_Count[7:0]};
