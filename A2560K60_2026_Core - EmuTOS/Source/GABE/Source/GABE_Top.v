...
// Joystick
input		wire					JOY0_BTN0_io,		// IO
input		wire					JOY0_BTN1_io,		// IO
input		wire					JOY0_BTN2_io,		// IO
...
input		wire					JOY1_BTN0_io,		// IO
input		wire					JOY1_BTN1_io,		// IO
input		wire					JOY1_BTN2_io,		// IO
...
// Data Path from the different Block
	...
	.Wait_SDCard_TA_o ( Wait_SDCard_TA_o )
);
...
A2560K_Unity IDE_And_Ethernet_DP(
	.CPU_Clk_i( CPU_Clk_i ),
	.IDE_Reset_i( Reset_i ), 
	.RST_i( Reset_i ),
	.CPU_A_i( iBUS_A_i ),
...
A2560K_Trinity Trinity_Block_Module(
	.CPU_Clk_i( CPU_Clk_i ),
	.RST_i( Reset_i ),
	.CPU_A_i( iBUS_A_i ),
	.CPU_D8_i( iBUS_D8_i  ),
