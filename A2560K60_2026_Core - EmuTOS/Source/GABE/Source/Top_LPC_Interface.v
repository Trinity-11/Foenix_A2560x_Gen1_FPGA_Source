...
// Status
	.PCI_Reset(PCI_Reset),
	.Config_Done_o( Config_Done_o ),		// [0:0]
...
assign wbs_adr_i 	= 	Config_Done_o ? BUS_Address : {16'h0000, LPC_Address};
assign wbs_dat_i 	= 	Config_Done_o ? {24'h000000, BUS_Data_In} : {24'h000000, LPC_Data_In};
assign wbs_we_i 	= 	Config_Done_o ? BUS_Write :	LPC_Write;
assign wbs_stb_i 	= 	Config_Done_o ? BUS_Strobe : LPC_Strobe;

assign LPC_Data_Out = Config_Done_o ? 32'h00000000 : wbs_dat_o;
assign BUS_Data_Out = Config_Done_o ? wbs_dat_o : 32'h00000000;

assign LPC_Ack = Config_Done_o ? 1'b0 : wbs_ack_o;
assign BUS_Ack = Config_Done_o ? wbs_ack_o : 1'b0;
assign LPC_Err = Config_Done_o ? 1'b0 : wbs_err_o;
assign BUS_Err = Config_Done_o ? wbs_err_o : 1'b0;

assign lpc_reset_o = PCI_Reset;

wb_lpc_host LPC_HOST_Block(
// Wishbone Slave Interface
	.clk_i( LPC_Clk_i ),
	.nrst_i( PCI_Reset ),					// Active low reset.
...
// LPC Master Interface
	.dma_chan_i( 3'h000 ), 			// DMA Channel input       [2:0] 	
	.dma_tc_i( 1'b0 ),				// DMA Terminal Count	
// LPC Interface
