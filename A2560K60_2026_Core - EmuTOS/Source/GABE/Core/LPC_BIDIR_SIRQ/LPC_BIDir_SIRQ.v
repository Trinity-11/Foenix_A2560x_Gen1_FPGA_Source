...
module  LPC_BIDir_SIRQ_iobuf_bidir_30p
	( 
	datain,
	dataio,
	dataout,
...
endmodule //LPC_BIDir_SIRQ_iobuf_bidir_30p
//VALID FILE
...
module LPC_BIDir_SIRQ (
	...
	LPC_BIDir_SIRQ_iobuf_bidir_30p	LPC_BIDir_SIRQ_iobuf_bidir_30p_component (
				.datain (datain),
				.oe (oe),
				.dataio (dataio),
				.dataout (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL LPC_BIDir_SIRQ_inst.v FALSE
