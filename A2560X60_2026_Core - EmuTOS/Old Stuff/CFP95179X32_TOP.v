...
output		wire				VClock_Slct_SYNC0n_o,	// *** NEW NAMING
output		wire				VClock_Slct_SYNC1n_o,	// *** NEW NAMING
output		wire				VClock_Slct_SCLK_o,		// *** NEW NAMING
output		wire				VClock_Slct_DIN_o,		// *** NEW NAMING
input		wire				OSC_CLK_80_000Mhz_A_i,		// *** NEW NAMING
input		wire				VideoClock_Out_B_i,		// *** NEW NAMING
// Debug Interface
input		wire				DBG_RX_i,
...
wire 	SYS_Clk33Mhz;
wire 	Clock133Mhz;
assign CPU_PCLK_o = 1'b0;		// Mera Speed
...
// New Signals = MC68LC060 Signal System
...
//	.Dbg_Halt_i( Dbg_Halt ),
	.TSF_FLASH2RAM_o(),
// Wait-State Section
	//.Wait_SDCard_TA_i( Wait_SDCard_TA ),
...
// Reset
	...
	// Clock for Channel B
	.Clk25_175Mhz_B_i( OSC_CLK_25_175Mhz_i ),	// Fixed - OSC	
...
// Video Clock Switches Interface	
	...
	.VClock_LTC6903_A_CSn_o( VClock_Slct_SYNC0n_o ),
	.VClock_LTC6903_B_CSn_o( VClock_Slct_SYNC1n_o ),
	.VClock_LTC6903_SCLK_o( VClock_Slct_SCLK_o ),
	.VClock_LTC6903_DIN_o( VClock_Slct_DIN_o ),
...
// Video RAM Bank A
	...
	.VRAM_A_BEn_o( VRAM_A_DQM_o ),
	.VRAM_A_Addy_o( VRAM_A_A_o ),
	.VRAM_A_OEn_o( VRAM_A_OEn_o ),
	.VRAM_A_WEn_o( VRAM_A_WEn_o ),
// Video RAM Bank B
	.VRAM_B_DQ_io( VRAM_B_DQ_io ),
	.VRAM_B_BEn_o( VRAM_B_DQM_o ),
	.VRAM_B_Addy_o( VRAM_B_A_o ),
...
// Video DAC Output B
	...
	.DP_HI_RES_MODE_A_i( HI_RES_MODE_A_i ),
	.DP_HI_RES_MODE_B_i( HI_RES_MODE_B_i ),
	.DP_GAMMA_MODE_A_i( GAMMA_MODE_A_i ), 
	.DP_GAMMA_MODE_B_i( GAMMA_MODE_B_i )
