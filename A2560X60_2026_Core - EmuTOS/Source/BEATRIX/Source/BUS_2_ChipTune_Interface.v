...
assign TP[7:0] 		= OPL3_D_o;
assign TP[9:8] 		= OPL3_A_o;
assign TP[10] 			= OPL3_CSn;
assign TP[11] 			= OPL3_RDn;
assign TP[12]			= OPL3_WRn;

//assign iBUS_Keyboard_D_o = 16'h0000;

assign Trigger = ReadRequest & ( FIFO_Pick[0] | FIFO_Pick[1] | FIFO_Pick[2] | FIFO_Pick[3] );

TinyChipScope CHIPSCOPE68K (
	.acq_data_in    (TP),    //        tap.acq_data_in
	.acq_trigger_in (Trigger), //           .acq_trigger_in
	.acq_clk        (OPL3_Clk_i),        //    acq_clk.clk
