...
VIII_VideoGen_B_New VideoTimingGen_B(
	...
	.VGE_Engine_VBlanking_1L_o( VGE_VBlanking_1L ),	// Vertical Frame Start - 1 Line  (original Resolution 1280x960/1280x1024)
	.VGE_Engine_VBlanking_2L_o( VGE_VBlanking_2L ),	// Vertical Frame Start - 2 Lines (Gaming Mode when in 640x480)
	.VGE_Engine_VBlanking_4L_o( VGE_VBlanking_4L ),	// Vertical Frame Start - 4 Lines (Gaming Mode when in 320x240)
	.SOF_o( SOF ),
...
// New Game System
	...
	.VBlanking_i( VBlanking  ),
	.VGE_Engine_VBlanking_2L_i( VGE_VBlanking_2L ), 
	.VGE_Engine_VBlanking_4L_i( VGE_VBlanking_4L ), 	
