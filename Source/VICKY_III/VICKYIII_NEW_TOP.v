...
// Channel B (principal)
input  		wire   					Clk108Mhz_B_i,				//Video108Mhz
...
wire 	[31:0] 		DataOut_EMUTOS_Graph;
wire 	[31:0] 		DataOut_MEMTEXT;
wire 	[31:0] 		DataOut_MEMTEXT_LUT;
wire 	[31:0] 		DataOut_MEMTEXT_FONT;
/*
wire [7:0] Source;
wire [31:0] Probe;
...
// CPU Interface
	...
	.GAMMA_B_A_Dout_i( iBUS_GAMMA_B_A_D ),
	.GAMMA_G_A_Dout_i( iBUS_GAMMA_G_A_D ),
	.GAMMA_R_A_Dout_i( iBUS_GAMMA_R_A_D ),	
	// Channel B
	...
	.CS_MEMTEXT_o( CS_MEMTEXT ),
	.CS_MEMTEXT_LUT_o( CS_MEMTEXT_LUT ),
	.CS_MEMTEXT_FONT_o( CS_MEMTEXT_FONT ),
	.CS_EMUTOS_GRAPH_o( CS_EMUTOS_GRAPH ),
	// DataOut - For CPU to Read
	...
	.DataOut_EMUTOS_Graph_i( DataOut_EMUTOS_Graph ),
	.DataOut_MEMTEXT_i( DataOut_MEMTEXT ),
	.DataOut_MEMTEXT_LUT_i( DataOut_MEMTEXT_LUT ),
	.DataOut_MEMTEXT_FONT_i( DataOut_MEMTEXT_FONT ),
// VGE	
...
// Reset
	.Reset_i( Reset_i ),
// Clocks
	.CPU_Clk_i( iBUS_1xClk_i ),				// CPU Clock - Could be 16/20/25/33/40/66/75
...
VICKY_III_Channel_B_NEW_Top Channel_B_Top(
// Reset
	.Reset_i( Reset_i ),
// Clocks
	.iBUS_1xClk_i( iBUS_1xClk_i ),					// CPU/BUS Speed
    .iBUS_2xClk_i( iBUS_2xClk_i ),					// BUS Speed x 2
	.iBUS_4xClk_i( iBUS_4xClk_i ),
	
	.Clk14_318Mhz_i( Clk14_318Mhz_i ),
	.Clk108Mhz_B_i( Clk108Mhz_B_i ),				// Video Clock Domain - 1280x960 / 1280x1024
	.Clk108Mhz_Locked_B_i( Clk108Mhz_Locked_B_i ),
	.OSC_CLK_25_175Mhz_i( OSC_CLK_25_175Mhz_i ),

	.Clk100M_i( Clk100M_B_i ),						// Engine Clock Domain
	.Clk200M_i( Clk200M_B_i ),						// 2x Engine Clock Domain
// DIP Switch
...
// VGE
	...
	.CS_LUT0_i( CS_LUT_B ),
	.CS_FONT_i( CS_FONT_B ), 		
	.CS_MEMTEXT_i( CS_MEMTEXT ),
	.CS_MEMTEXT_LUT_i( CS_MEMTEXT_LUT ),
	.CS_MEMTEXT_FONT_i( CS_MEMTEXT_FONT ),
	.CS_EMUTOS_GRAPH_i( CS_EMUTOS_GRAPH ),
// General
...
// New Stuff - GUI Block
	.DataOut_EMUTOS_Graph_o( DataOut_EMUTOS_Graph ),
	.DataOut_MEMTEXT_o( DataOut_MEMTEXT ),
	.DataOut_MEMTEXT_LUT_o( DataOut_MEMTEXT_LUT ),
	.DataOut_MEMTEXT_FONT_o( DataOut_MEMTEXT_FONT ),	
// General
