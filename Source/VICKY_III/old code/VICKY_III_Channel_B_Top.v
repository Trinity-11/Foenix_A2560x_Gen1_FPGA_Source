module VICKY_III_Channel_B_Top (
...
wire 				VideoClkOut;
wire				Mstr_Ctrl_Doubling_Pixel_PLL;
wire				Mstr_Ctrl_Video_Mode_PLL_Aux;
//VIDEO_PLL	VIDEO_PLL_B (
//	.inclk0 ( Video_Clk_B_i ),
...
VIDEO_PLL_CHANNELB	VIDEO_PLL_B (
	.inclk0 ( Clk25_175Mhz_i ),
	.inclk1 ( Clk40_000Mhz_i ),
...
//assign PLL_Locked_B = 1'b1;
Clk_Switch u0 (
	.clkselect ( Mstr_Ctrl_Doubling_Pixel_PLL ), //                  .clkselect	
...
// Vicky Master Control
	...
	.Mstr_Ctrl_Pixel_Division_o(   ),												// CPU Clock Domain [1:0]
	.Mstr_Ctrl_Pixel_Division_100MhzResynced_o( Mstr_Ctrl_Doubling_Pixel_100Mhz ),  // Engine Clock Domain (100Mhz)

	
	.Mstr_Ctrl_Video_Mode_PLL_o( Mstr_Ctrl_Video_Mode_PLL ),
	.Mstr_Ctrl_Doubling_Pixel_PLL_o( Mstr_Ctrl_Doubling_Pixel_PLL ), 
...
SourceAndProbe VideoStuff (
	.source (Source), // sources.source
	.probe  (Probe)   //  probes.probe
);
assign Probe[1:0] = Mstr_Ctrl_Video_Mode[1:0];
assign Probe[3:2] = Mstr_Ctrl_Video_Mode_100Mhz[1:0];
assign Probe[5:4] = Mstr_Ctrl_Video_Mode_PLL[1:0];
assign Probe[7:6] = Mstr_Ctrl_Video_Mode_CPU[1:0];

assign Probe[8] = Mstr_Ctrl_Doubling_Pixel;
assign Probe[9] = Mstr_Ctrl_Doubling_Pixel_100Mhz;
assign Probe[10] = Mstr_Ctrl_Doubling_Pixel_PLL;
assign Probe[11] = 1'b1;
*/
// Next to the Power Connector
GraphicOutputMixer PixelMixer_Channel_B(
// CPU Interface
	.CPU_Clk_i( CPU_Clk_i ),
	.CPU_D8_i( iBUS_D8_i ),
...
VideoTimingGenerator_B VideoTimingGen_B(
...
VideoModeTimingInfo_B VideoMode_Info_B(
...
// Channel B
VIII_Text_Block_B Monochrome_FONT_Block(
	.VideoClk_i( VideoClkOut ),
	.VideoRst_i( Reset_VideoClkOut ),
...
wire TLayer0Mode8_16;
wire TLayer1Mode8_16;
wire TLayer2Mode8_16;
wire TLayer3Mode8_16;

VGE_MasterController_Module VGE_MasterCTRL_Module_B(
	// System Reset
	...
	.Mstr_Ctrl_Video_Mode_i( Mstr_Ctrl_Video_Mode ),
	.Mstr_Ctrl_Doubling_Pixel_i( Mstr_Ctrl_Doubling_Pixel ),
	.Mstr_Ctrl_Doubling_Pixel_100Mhz_i( Mstr_Ctrl_Doubling_Pixel_100Mhz ), 
	...
	.CS_LUT0_i( CS_LUT0_i ),
	.CS_VIDEO_RAM_B0_i( CS_VIDEO_RAM_B0_i ),
	.CS_VIDEO_RAM_B1_i( CS_VIDEO_RAM_B1_i ),
