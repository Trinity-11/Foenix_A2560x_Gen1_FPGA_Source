...
//assign CPU_RESET_INn_o 	= Dbg_Mode_On_i ?  Dbg_RSTn_i : CPU_RSTn;
...
//assign CPU_TAn_o        = CS_NO_MANSLAND ? 1'b1 : CPU_TAn;
...
assign DataBufferOELogic 		= TSF_FLASH2RAM_o ? (Dbg_Mode_On_i ? !Dbg_RWn_Out_i : (CPU_RWn_i & ( CS_Registers | CS_GET_VECTOR_INT | CS_NO_MANSLAND))) : 1'b0;
...
wire   DEAD_ZONE0	    		= ( Internal_Address[31:22] == 10'b0000_0000_01 )  & !CPU_TIPn_i; 		//$0040_0000 - $007F_FFFF (4Meg)
// Video RAM
...
wire   DEAD_ZONE2	    		= (( Internal_Address > 32'h03FF_FFFF ) & ( Internal_Address < 32'hFE00_0000 )) & !CPU_TIPn_i;
// Internal Registers
...
wire VICKY = (CS_VICKY_A | CS_VICKY_MEM_A | CS_VICKY_B | CS_VICKY_MEM_B | CS_VRAM_A | CS_VRAM_B );

always @ (*) begin
	case({ CS_GET_VECTOR_INT, VICKY, CS_BEATRIX, CS_MERA, CS_GAVIN, CS_NO_MANSLAND})
		6'b00_0001: Data_Out_Mux = 32'h0000_0000;			// PCI Core Control/Config Mapped Spaced		
		6'b00_0010: Data_Out_Mux = iBUS_D_GAVIN_i;			// PCI Core Control/Config Mapped Spaced	
		6'b00_0100: Data_Out_Mux = iBUS_D_MERA_i;			// PCI Core Control/Config Mapped Spaced
		6'b00_1000: Data_Out_Mux = iBUS_D_BEATRIX_i;					// Everything System
		6'b01_0000: Data_Out_Mux = iBUS_D_VICKY_i;					// Big Chunk of Memory
		6'b10_0000: Data_Out_Mux = {24'h00_0000, iIRQ_Vector_i};	// 
...
0xFEC4:0000 0xFEC5:FFFF 8/16/32 I/O R/W VKY III ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Chan A ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ (Text/Graphics Controller)
0xFEC6:0000 0xFEC6:3FFF 8 MEM R/W VKY III ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Chan A ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Text Memory Block
0xFEC6:8000 0xFEC6:FFFF 8 MEM R/W VKY III ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Chan A ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Text Color Memory Block
0xFEC8:0000 0xFEC9:FFFF 8/16/32 I/O R/W VKY III ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Chan B ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ (Text/Graphics Controller)
0xFECA:0000 0xFECA:3FFF 8 MEM R/W VKY III ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Chan B ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Text Memory Block
0xFECA:8000 0xFECA:FFFF 8 MEM R/W VKY III ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Chan B ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Text Color Memory Block
*/
...
assign Trigger = ((ADDY_In == Source) & TSF_FLASH2RAM_o);
//assign Trigger = CPU_TEAn_o;
//assign Trigger = (ADDY_In == Source);
