...
assign CPU_TBIn_o					=  LineTransfer ? 1'b1 :   { SIZ1, SIZ0 } == 2'b11  ? DTACK : 1'b1 ; // So right now, LINE16 is allowed only in SRAM
...
always @ ( * ) begin 
	casex ( {!TSF_FLASH2RAM_o, Dbg_Mode_On_i, iBUS_Master } )
		...
		3'b000: begin 
			...
			DataBufferOELogic = (CPU_RWn_i & ( CS_Registers | CS_GET_VECTOR_INT | CS_NO_MANSLAND | CS_VRAM_B | CS_VRAM_A | CS_MERA ));
		end
...
// System Signals
	.MODE_060_040_i( 1'b0 ),			// 0: 68040, 1: 68060
...
assign DEAD_ZONE2	    			= (( Internal_Address > 32'h05FF_FFFF ) & ( Internal_Address < 32'hFE00_0000 )) & !CPU_TIPn_i;
// Internal Registers
...
//assign DataCachePush 				= (FC[2:0] == 3'b000);	// Not Used
assign UserData 					= (FC[2:0] == 3'b001);		// LINE16
assign UserProgram 					= (FC[2:0] == 3'b010);
//assign MMU_Table_Search_Data 		= (FC[2:0] == 3'b011); 	// Not Used
//assign MMU_Table_Search_Code 		= (FC[2:0] == 3'b100);	// Not Used
...
assign VICKY 						= (CS_VICKY_A | CS_VICKY_MEM_A | CS_VICKY_B | CS_VICKY_MEM_B  );
...
assign TP[122]  	= CPU_PST0_i;
assign TP[123]  	= CPU_PST1_i;
assign TP[124]  	= CPU_PST2_i;
assign TP[125]  	= CPU_PST3_i;
assign TP[126] 		= 1'b0;
...
assign TP[135] 		= CPU_IPL0n_o;
assign TP[136] 		= CPU_IPL1n_o;
assign TP[137] 		= CPU_IPL2n_o;
assign TP[138] 		= 1'b0;
