...
// Just for the A2560X60+
input 		wire  				WIFI_WIZFI_IRQn_i,
input 		wire  				WIFI_Rx_FIFO_IRQn_i,
...
reg [2:0] WIFI_WIZFI_IRQn_ReSync;
reg [2:0] WIFI_Rx_FIFO_IRQn_ReSync;

always @ (posedge CPU_Clk_i ) begin

	WIFI_WIZFI_IRQn_ReSync[0] <= WIFI_WIZFI_IRQn_i;
	WIFI_WIZFI_IRQn_ReSync[1] <= WIFI_WIZFI_IRQn_ReSync[0];
	if ( WIFI_WIZFI_IRQn_ReSync[1] == WIFI_WIZFI_IRQn_ReSync[0] )
		WIFI_WIZFI_IRQn_ReSync[2] <= WIFI_WIZFI_IRQn_ReSync[1];

	WIFI_Rx_FIFO_IRQn_ReSync[0] <= WIFI_Rx_FIFO_IRQn_i;
	WIFI_Rx_FIFO_IRQn_ReSync[1] <= WIFI_Rx_FIFO_IRQn_ReSync[0];
	if ( WIFI_Rx_FIFO_IRQn_ReSync[1] == WIFI_Rx_FIFO_IRQn_ReSync[0] )
		WIFI_Rx_FIFO_IRQn_ReSync[2] <= WIFI_Rx_FIFO_IRQn_ReSync[1];
...
assign TinyTrigger1 = irq_o_RESYNC[2][1];		//Int1 = Keyboard, Int2 = Mouse
...
assign TinyTP1[69]		= CPU_WE_i;
assign TinyTP1[117:70] 	= pending[47:0];
assign TinyTP1[125:118] = irq_o_RESYNC[2][7:0];
...
always @(posedge CPU_Clk_i) begin
	lirq0 <= {  DAC0_Playback_Done_IRQ_i, 1'b0, DAC1_Playback_Done_IRQ_i, 1'b0, BTX_IRQ_i[3:0], WIFI_WIZFI_IRQn_ReSync[2], WIFI_Rx_FIFO_IRQn_ReSync[2], OPL3_EXT_IRQ_i, OPN2_EXT_IRQ_i, OPM_IXT_IRQ_i, SD_IRQ_i, SD_Card_Insert_i, IDE_IRQ_i,
					RTC_int_PulSe[3], ETH_int_PulSe[3], Trinity_IRQ_i, ~Timer4_i, ~Timer3_i, ~Timer2_i, ~Timer1_i, ~Timer0_i, !MPU_401_int_PulSe[3], !FDC_int_PulSe[3], !LPT1_int_PulSe[3], !COM2_int_PulSe[3], !COM1_int_PulSe[3], !Mouse_int_PulSe[3], 1'b0 , !Keyboard_int_PulSe[3], //16bits
...
/*
// March 8th, 2026
00 - SOF Channel A						10 - PS2 Keyboard						20 - IDE IRQ
01 - SOL Channel A						11 - RESERVED							21 - SD CARD INSERTS
02 - Channel A IRQ2	- TBD				12 - PS2 MOUSE			     			22 - SD CARD ???
03 - Channel A IRQ3 - TBD				13 - SUPER IO COM1 						23 - External OPM IRQ
04 - Channel A IRQ4 - TBD				14 - SUPER IO COM2						24 - External OPN2 IRQ
05 - Channel A IRQ5 - TBD				15 - SUPER IO LPT1						25 - External OPL3 IRQ
06 - RESERVED							16 - SUPER IO FDC						26 - WIZFI RxD FIFO IRQ
07 - Channel A Hot-Plug IRQ				17 - SUPER IO MPU401					27 - WIZFI Module IRQ
08 - SOF Channel B						18 - TIMER0								28 - RESERVED
09 - SOL Channel B						19 - TIMER1								29 - RESERVED
0A - Channel B IRQ2	- TBD				1A - TIMER2								2A - RESERVED
0B - Channel B IRQ3 - TBD				1B - TIMER3								2B - RESERVED
0C - Channel B IRQ4 - TBD				1C - TIMER4								2C - RESERVED
0D - Channel B IRQ5 - TBD				1D - TRINITY IRQ						2D - Playback Done DAC1
0E - RESERVED							1E - LAN9221 IRQ						2E - RESERVED
0F - Channel B Hot-Plug IRQ				1F - RTC IRQ							2F - Playback Done DAC0
*/
