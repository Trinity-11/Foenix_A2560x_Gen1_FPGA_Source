...
//////////////////////////////////////
//
// RTC Logic in K Systems
//
//////////////////////////////////////

always @ ( posedge iBUS_1xClk_i ) begin
	if ( Reset_i ) begin
		RTC_Slide <= 16'h0000;
	end 
	else begin
...
A2560K_GAVIN_CS_And_Dout GAVIN_CS_DOUT(
// CPU Interface
...
// Data Path from the different Block
	...
	.DataOut_IRQ_i( DataOut_IRQ_CTRL ),		//x1
	...
	.DataOut_JOY_i( DataOut_Joystick ),				//x1
	...
	.CS_IRQ_o( CS_Interrupt_Ctrl ),				// Interrupt Controller
...
`ifdef A2560K40
	A2560K40_GAVIN_CTRL GABE_CTRL(
		...
		.CHIP_NUMBER( 16'h5183 ),
		.CHIP_VERSION( 16'h0003 ),
		.CHIP_SUBVERSION( 16'h5555 ),
...
`elsif A2560K60
	...
	A2560K60_GAVIN_CTRL GABE_CTRL(
		...
		.CHIP_NUMBER( 16'h5185 ),
		.CHIP_VERSION( 16'h0009 ),
		.CHIP_SUBVERSION( 16'h0369 ),
