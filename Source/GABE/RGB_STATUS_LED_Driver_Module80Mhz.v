module RGB_STATUS_LED_Driver_Module80Mhz (

input		wire				Clk80Mhz_i,
input		wire				Reset_i,
input		wire				SOF_i,
input		wire	[23:0]		RGB_Value0_i,
input		wire	[23:0]		RGB_Value1_i,
input		wire	[23:0]		RGB_Value2_i,
...
reg [23:0] RGB_Value_ReSync0[0:2];
reg [23:0] RGB_Value_ReSync1[0:2];
reg [23:0] RGB_Value_ReSync2[0:2];

always @ ( posedge Clk40Mhz_i ) begin
			RGB_Value_ReSync0[0] <= RGB_Value0_i;
			RGB_Value_ReSync0[1] <= RGB_Value_ReSync0[0];
			if ( RGB_Value_ReSync0[0] == RGB_Value_ReSync0[1] ) begin
				RGB_Value_ReSync0[2] <= RGB_Value_ReSync0[1];
			end
			
			RGB_Value_ReSync1[0] <= RGB_Value1_i;
			RGB_Value_ReSync1[1] <= RGB_Value_ReSync1[0];
			if ( RGB_Value_ReSync1[0] == RGB_Value_ReSync1[1] ) begin
				RGB_Value_ReSync1[2] <= RGB_Value_ReSync1[1];
			end

			RGB_Value_ReSync2[0] <= RGB_Value2_i;
			RGB_Value_ReSync2[1] <= RGB_Value_ReSync2[0];
			if ( RGB_Value_ReSync2[0] == RGB_Value_ReSync2[1] ) begin
				RGB_Value_ReSync2[2] <= RGB_Value_ReSync2[1];
			end			
end
/*
wire [8:0] Source;
...
always @ (*) begin
				case( LedChoice )
					2'b00: Demon 	<= {RGB_Value_ReSync0[2][15:8], RGB_Value_ReSync0[2][23:16], RGB_Value_ReSync0[2][7:0]};
					2'b01: Demon 	<= {RGB_Value_ReSync1[2][15:8], RGB_Value_ReSync1[2][23:16], RGB_Value_ReSync1[2][7:0]};
					2'b10: Demon 	<= {RGB_Value_ReSync2[2][15:8], RGB_Value_ReSync2[2][23:16], RGB_Value_ReSync2[2][7:0]};
					default: Demon 	<= {RGB_Value_ReSync0[2][15:8], RGB_Value_ReSync0[2][23:16], RGB_Value_ReSync0[2][7:0]};
				endcase
end
	...
	if ( Reset_i ) begin
		...
		2'b00: begin 
			...
			if ( {SOF_RESYNC[3], SOF_RESYNC[2]} == 2'b01 ) begin
				RGB_Value_Slide <= Demon;
				LedChoice <= LedChoice + 2'b01;				
				Count <= 8'h00;
				bitsteam_out <= 1'b1;				
				Bit2Transmit <= 8'h00;
				SmallSM <= 2'b01;
