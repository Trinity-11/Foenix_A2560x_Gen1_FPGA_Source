...
localparam 		CPU_SPEED_ID = 4'b0011,	// 3 = 33Mhz
					MACHINE_ID   = 4'b1000,	// 8 = A2560X
					CPU_ID       = 4'b0110; // 6 = MC68040V


localparam 		HW_REV_DIGIT0	= 8'h41, //A (ASCII)			  
					HW_REV_DIGIT1 	= 8'h30, //0 (ASCII)
					HW_REV_DIGIT2 	= 8'h42, //B (ASCII)
					HW_DATE_YR   	= 8'h26, // 26  (Decimal)
					HW_DATA_MT   	= 8'h02, // Feb (Decimal)
					HW_DATA_DY   	= 8'h17; // 11 (Decimal)
			  

localparam 		FM_DATE_YR  = 8'h26, // 22 (Decimal)
					FM_DATE_MT  = 8'h02, // 01 (Decimal)
					FM_DATE_DY  = 8'h17; //
