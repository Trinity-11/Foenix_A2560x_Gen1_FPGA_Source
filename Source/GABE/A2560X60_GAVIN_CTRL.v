...
output		wire				SDCARD_LED0_o,
output		wire				SDCARD_LED1_o,
output      wire   				Network_LED_o,

output		wire				Manual_RESET_o,
output		wire				LPC_RSTn_o,

output		wire	[23:0]		POWER_ON_RGB_Value_o,
output      wire   	[23:0]		SDC0_RGB_Value_o,
output      wire   	[23:0]		SDC1_RGB_Value_o,
output      wire   	[23:0]		NETWORK_RGB_Value_o, 
...
localparam 		    CPU_SPEED_ID = 4'b0011,	// 6 = 66Mhz
					MACHINE_ID   = 4'b1000,	// 8 = A2560X
					CPU_ID       = 4'b1011; // B = MC68060


localparam 		HW_REV_DIGIT0	= 8'h41, //A (ASCII)			  
			  	HW_REV_DIGIT1 	= 8'h30, //0 (ASCII)
			  	HW_REV_DIGIT2 	= 8'h42, //B (ASCII)
			  	HW_DATE_YR   	= 8'h26, //21  (Decimal)
			  	HW_DATA_MT   	= 8'h02, // Nov (Decimal)
			  	HW_DATA_DY   	= 8'h11; // 03 (Decimal)
...
assign SDCARD_LED0_o 	= ControlRegisters[0][1];
assign SDCARD_LED1_o 	= ControlRegisters[0][2];
assign Network_LED_o 	= ControlRegisters[0][3];
...
assign POWER_ON_RGB_Value_o 	= {ControlRegisters[4][23:0]};
assign SDC0_RGB_Value_o 		= {ControlRegisters[5][23:0]};
assign SDC1_RGB_Value_o 		= {ControlRegisters[6][23:0]};
assign NETWORK_RGB_Value_o 		= {ControlRegisters[7][23:0]};
