module A2560K_GAVIN_CS_And_Dout (
// CPU Interface
...
output	    wire				CS_IRQ_o,		// Interrupt Controller
...
assign CS_IRQ_o					= ( iBUS_A_i[16:8] == 9'b0_0000_0001) & iBUS_CS_GAVIN_i;		// $FEC00100..$FEC001FF - Interrupt Controllers
...
assign CS_JOY_o					= ( iBUS_A_i[16:8] == 9'b0_0000_0101) & iBUS_CS_GAVIN_i;		// $FEC00500..$FEC005FF - JOYSTICK/JOYPAD
...
wire CS_OR_A;
wire [4:0] CS_Combined_B;
wire CS_OR_B;
reg [31:0] DataOut_A;
reg [31:0] DataOut_B;

assign CS_Combined_A = ( { CS_NIC_o, CS_JOY_o, CS_IDE_o, CS_SDCard_o, CS_Timer_o, CS_IRQ_o, CS_RTC_o, CS_A2560K_KB_o, CS_GABE_Config_o });
assign CS_OR_A = (   CS_NIC_o | CS_JOY_o | CS_IDE_o | CS_SDCard_o | CS_Timer_o | CS_IRQ_o | CS_RTC_o | CS_A2560K_KB_o | CS_GABE_Config_o );
...
always @ ( posedge iBUS_2xClk_i) begin
	case (CS_Combined_A)
		...
		9'b000_000_010: begin DataOut_A = DataOut_A2560K_KB_i; 			end
		9'b000_000_100: begin DataOut_A = DataOut_RTC_i; 				end
		9'b000_001_000: begin DataOut_A = DataOut_IRQ_i;				end
		...
		9'b010_000_000: begin DataOut_A = DataOut_JOY_i; 				end
		9'b100_000_000: begin DataOut_A = DataOut_IDE_ETH_DPS_i; 		end
		default: begin DataOut_A = 32'hB00B_FEED; 						end
	endcase
end

assign CS_Combined_B = ( { CS_SDMA_o, CS_VDMA_o,  CS_MATH_FLOAT_o,  CS_MATH_FIXED_o,  CS_LPC_o});
assign CS_OR_B 		 = (  CS_SDMA_o | CS_VDMA_o | CS_MATH_FLOAT_o | CS_MATH_FIXED_o | CS_LPC_o );

always @ ( posedge iBUS_2xClk_i) begin
	case (CS_Combined_B)
		5'b0_0000: 	begin DataOut_B = 32'hDEAD_BEEF; 			end
		5'b0_0001: 	begin DataOut_B = DataOut_LPC_Interface_i;	end
		5'b0_0010: 	begin DataOut_B = DataOut_Math_Fixed_i; 	end
		5'b0_0100: 	begin DataOut_B = DataOut_Math_Float_i; 	end
		5'b0_1000: 	begin DataOut_B = DataOut_VDMA_i;			end
		5'b1_0000: 	begin DataOut_B = DataOut_SDMA_i;     		end
