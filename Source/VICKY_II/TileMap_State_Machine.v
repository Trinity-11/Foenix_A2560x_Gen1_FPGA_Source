...
// this is the number of Words to Read from the VRAM
always @ (*) begin
	case({TileSize8_16, Mstr_Ctrl_Doubling_Pixel_100Mhz_i})
		2'b00: MaxValueTileMap2BeRead = 8'd22;	// (42) 16 + 640 + 16 ( 1 + 40 + 1) Y: 480 + 32 = 32 Tiles (Tiles / 2) + 2
		2'b01: MaxValueTileMap2BeRead = 8'd12;	// (22) 16 + 320 + 16 ( 1 + 20 + 1) Y: 240 + 32 = 15 Tiles
		2'b10: MaxValueTileMap2BeRead = 8'd42;	// (82) 8 + 640 + 8 ( 1 + 80 + 1) Y: 480 + 16 = 32 Tiles (Tiles / 2) + 2
		2'b11: MaxValueTileMap2BeRead = 8'd22;	// (22) 8 + 320 + 8 ( 1 + 40 + 1) Y: 240 + 16 = 15 Tiles
	endcase
end
...
// With new Clock, always 108Mhz, so always 1280 horizontal pure pixel, but game engine does 640 and 320 only.
always @ (*) begin
	case({ TileSize, Mstr_Ctrl_Doubling_Pixel_100Mhz_i})
		2'b00: NumberOfTile2Read = 8'd44;	// (42) 16 + 640 + 16 	( 1 + 40 + 1)		// Tile is 16x16
		2'b01: NumberOfTile2Read = 8'd24;	// (42) 16 + 320 + 16 	( 1 + 20 + 1)		// Doubling Mode
		2'b10: NumberOfTile2Read = 8'd84;	// (42) 8 + 640 + 8 	( 1 + 80 + 1)		// Tile is 8x8
		2'b11: NumberOfTile2Read = 8'd44;	// (42) 8 + 320 + 8 	( 1 + 20 + 1) 		// Doubling Mode	
	endcase
end	
...
always @ (*) begin
	case( {   TileSize, Mstr_Ctrl_Doubling_Pixel_100Mhz_i} ) 
		2'b00: TileLinePointer = ({1'b0, Horizontal_Line_Count_i[4:1]} + Offset);	// 1/2 of 960 or 1024 , Offset <= {1'b0, (4'b1111 - Tile_Y_Scroll_Reg[TileBank][3:0])
		2'b01: TileLinePointer = ({1'b0, Horizontal_Line_Count_i[5:2]} + Offset);	// 1/4 of 960 or 1024
		2'b10: TileLinePointer = ({2'b00, Horizontal_Line_Count_i[3:1]} + Offset); 	//{2'b00, (3'b111 - Tile_Y_Scroll_Reg[TileBank][2:0])}
		2'b11: TileLinePointer = ({2'b00, Horizontal_Line_Count_i[5:2]} + Offset);
	endcase
end
...
begin
	case ( { TileSize, TileStride256x256} ) 
		...
		2'b11: Pixel2FetchCounter_TL = {2'b00, Active_Tile_Data[7:4], TileLinePointer[2:0], Active_Tile_Data[3:0], 3'b000};
	endcase
end
