...
input		wire				VideoClk_i,						// 25.175Mhz
...
input   	wire   				VGE_Engine_VBlanking_4L_i,
...
// Okay, so bank A is for Bitmap & Tiles
...
// V(DRAM) Interface A
// Video RAM Bank A
	.VRAM_DQ_i( VRAM_A_DQ_i ),
	.VRAM_DQ_o( VRAM_A_DQ_o ),
...
// Okay, so bank B is for Sprites Only
...
// Channel 1 - Read Only 32Bits Access
	.BitMap_Target_Enable_i(  1'b0 ),
	.BitMap_Target_Load_i(  1'b0 ),
	.BitMap_Target_Addy_Start_i( 20'h0_0000 ),
	.BitMap_Target_Addy_Stop_i( 20'h0_0000 ),
// Channel 2 - Read Only 32Bits Access
...
// V(DRAM) Interface A
// Video RAM Bank A
	.VRAM_DQ_i( VRAM_B_DQ_i ),
	.VRAM_DQ_o( VRAM_B_DQ_o ),
...
always @ (posedge EngineClk100Mhz_A_i) begin
	...
	VGE_VBlanking_ReSYNC[0] <= ( Mstr_Ctrl_Doubling_Pixel_i ? !VGE_Engine_VBlanking_4L_i : !VGE_Engine_VBlanking_2L_i );		// Negated VGE_VBlanking_i
...
assign CS[34:31]  	= VGE_Bitmap_Engine_SM_A;
assign CS[35] 		= Counter_Enable_BM_A;
assign CS[36] 		= Counter_Load_BM_A;
assign CS[37] 		= Data_Output_Valid_A;
assign CS[38] 		= Read_Pixel_Lines;
assign CS[39]		= Time_Trf_Pixels_2_Pixel_200Mhz_i;
assign CS[71:40]	= VRAM_Data_2_BITMAP_A;
assign CS[79:72]    = Line0_Pixel_Out; 
...
always @ (posedge EngineClk100Mhz_A_i) begin
	if (VideoModeReset_100Mhz_i | Reset_100Mhz_i) begin
		...
		BITMAP_PROCESS2: 
		begin
		if (((VGE_Bitmap_Engine_SM_A == BM_TRF_DONE) & BitmapChannel_A_Enable) )  begin			
...
wire [9:0]	BM_Line_Sizes;
//reg [9:0]	BM_Packet_Number;

// 32+640+32 or 32+320+32
assign BM_Line_Sizes = Mstr_Ctrl_Doubling_Pixel_100Mhz_i ? 10'd384 : 10'd704;
