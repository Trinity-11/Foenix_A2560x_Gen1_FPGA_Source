...
DMA_MULT_BLK TileMapAddyOrigineCompute(
	...
	.dataa( { 5'b0000_0, BitMap_Line_Sizes[10:0]} ),				// Size of the Map x 2 (1x Short per Tile) since we are computing Address
	.datab( Mstr_Ctrl_Doubling_Pixel_i ? { 6'b00_0000, Horizontal_Line_Count_i[11:2]} : { 5'b0_0000, Horizontal_Line_Count_i[11:1]} ), 	// Number of line
...
assign BitMap_Line_Sizes = Mstr_Ctrl_Doubling_Pixel_100Mhz_i ? 11'd320 : 11'd640;
