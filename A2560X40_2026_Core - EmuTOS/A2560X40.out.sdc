## Generated SDC file "A2560X40.out.sdc"
...
create_generated_clock -name {Sys133Mhz} -source [get_pins {PLL_SDCard_Debug_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 5 -divide_by 3 -master_clock {OSC_CLK_80_000Mhz_i} [get_pins {PLL_SDCard_Debug_inst|altpll_component|auto_generated|pll1|clk[1]}] 
...
create_generated_clock -name {Clk199Mhz} -source [get_pins {PLL_SDCard_Debug_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 5 -divide_by 2 -master_clock {OSC_CLK_80_000Mhz_i} [get_pins {PLL_SDCard_Debug_inst|altpll_component|auto_generated|pll1|clk[3]}] 
...
# Set False Path
#**************************************************************
set_false_path  -from  [get_clocks {CLK33MHz}]  -to  [get_clocks {Clk199Mhz}]
