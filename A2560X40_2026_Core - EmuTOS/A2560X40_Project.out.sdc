...
create_clock -name {OSC_CLK_33_333Mhz_B_i} -period 30.000 -waveform { 0.000 15.000 } [get_ports {OSC_CLK_33_333Mhz_B_i}]
create_clock -name {OSC_CLK_33_333Mhz_C_i} -period 30.000 -waveform { 0.000 15.000 } [get_ports {OSC_CLK_33_333Mhz_C_i}]
...
create_generated_clock -name {Clk199Mhz} -source [get_pins {PLL_SDCard_Debug_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 5 -divide_by 2 -master_clock {OSC_CLK_80_000Mhz_A_i} [get_pins {PLL_SDCard_Debug_inst|altpll_component|auto_generated|pll1|clk[3]}] 
create_generated_clock -name {CLK66MHz} -source [get_nets {PLL_SDCard_Debug_inst|altpll_component|auto_generated|wire_pll1_clk[1]}] -divide_by 2 -master_clock {Sys133Mhz} [get_nets {M68040V|ClockDivide[0]}] 
create_generated_clock -name {CLK33MHz} -source [get_nets {PLL_SDCard_Debug_inst|altpll_component|auto_generated|wire_pll1_clk[1]}] -divide_by 4 -master_clock {Sys133Mhz} [get_nets {M68040V|ClockDivide[1]}] 
...
create_generated_clock -name {CLK108Mhz} -source [get_ports {OSC_CLK_40_000Mhz_A_i}] -duty_cycle 50.000 -multiply_by 1 -master_clock {OSC_CLK_40_000Mhz_A_i} [get_nets {PLL_40Mhz_108Mhz_inst|altpll_component|auto_generated|wire_pll1_clk[0]}] 
...
#**************************************************************
set_clock_uncertainty -rise_from [get_clocks {CLK99MHz}] -rise_to [get_clocks {CLK99MHz}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {CLK99MHz}] -fall_to [get_clocks {CLK99MHz}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {CLK99MHz}] -rise_to [get_clocks {CLK33MHz}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {CLK99MHz}] -fall_to [get_clocks {CLK33MHz}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {CLK99MHz}] -rise_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {CLK99MHz}] -fall_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {CLK99MHz}] -rise_to [get_clocks {CLK99MHz}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {CLK99MHz}] -fall_to [get_clocks {CLK99MHz}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {CLK99MHz}] -rise_to [get_clocks {CLK33MHz}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {CLK99MHz}] -fall_to [get_clocks {CLK33MHz}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {CLK99MHz}] -rise_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {CLK99MHz}] -fall_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {CLK33MHz}] -rise_to [get_clocks {CLK99MHz}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {CLK33MHz}] -fall_to [get_clocks {CLK99MHz}]  0.030  
...
set_clock_uncertainty -rise_from [get_clocks {CLK33MHz}] -rise_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {CLK33MHz}] -fall_to [get_clocks {Clk199Mhz}]  0.020  
...
set_clock_uncertainty -fall_from [get_clocks {CLK33MHz}] -rise_to [get_clocks {CLK99MHz}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {CLK33MHz}] -fall_to [get_clocks {CLK99MHz}]  0.030  
...
set_clock_uncertainty -fall_from [get_clocks {CLK33MHz}] -rise_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {CLK33MHz}] -fall_to [get_clocks {Clk199Mhz}]  0.020  
...
set_clock_uncertainty -rise_from [get_clocks {Clk199Mhz}] -rise_to [get_clocks {CLK99MHz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {Clk199Mhz}] -fall_to [get_clocks {CLK99MHz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {Clk199Mhz}] -rise_to [get_clocks {CLK33MHz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {Clk199Mhz}] -fall_to [get_clocks {CLK33MHz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {Clk199Mhz}] -rise_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {Clk199Mhz}] -fall_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Clk199Mhz}] -rise_to [get_clocks {CLK99MHz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Clk199Mhz}] -fall_to [get_clocks {CLK99MHz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Clk199Mhz}] -rise_to [get_clocks {CLK33MHz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Clk199Mhz}] -fall_to [get_clocks {CLK33MHz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Clk199Mhz}] -rise_to [get_clocks {Clk199Mhz}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {Clk199Mhz}] -fall_to [get_clocks {Clk199Mhz}]  0.020  
...
set_clock_uncertainty -rise_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -rise_to [get_clocks {CLK33MHz}] -setup 0.060  
set_clock_uncertainty -rise_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -rise_to [get_clocks {CLK33MHz}] -hold 0.090  
set_clock_uncertainty -rise_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -fall_to [get_clocks {CLK33MHz}] -setup 0.060  
set_clock_uncertainty -rise_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -fall_to [get_clocks {CLK33MHz}] -hold 0.090  
set_clock_uncertainty -fall_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -rise_to [get_clocks {CLK33MHz}] -setup 0.060  
set_clock_uncertainty -fall_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -rise_to [get_clocks {CLK33MHz}] -hold 0.090  
set_clock_uncertainty -fall_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -fall_to [get_clocks {CLK33MHz}] -setup 0.060  
set_clock_uncertainty -fall_from [get_clocks {OSC_CLK_80_000Mhz_A_i}] -fall_to [get_clocks {CLK33MHz}] -hold 0.090  
...
set_clock_uncertainty -rise_from [get_clocks {CLK108Mhz}] -rise_to [get_clocks {CLK99MHz}]  0.160  
set_clock_uncertainty -rise_from [get_clocks {CLK108Mhz}] -fall_to [get_clocks {CLK99MHz}]  0.160  
...
set_clock_uncertainty -rise_from [get_clocks {CLK108Mhz}] -rise_to [get_clocks {Clk199Mhz}]  0.160  
set_clock_uncertainty -rise_from [get_clocks {CLK108Mhz}] -fall_to [get_clocks {Clk199Mhz}]  0.160  
...
set_clock_uncertainty -fall_from [get_clocks {CLK108Mhz}] -rise_to [get_clocks {CLK99MHz}]  0.160  
set_clock_uncertainty -fall_from [get_clocks {CLK108Mhz}] -fall_to [get_clocks {CLK99MHz}]  0.160  
...
set_clock_uncertainty -fall_from [get_clocks {CLK108Mhz}] -rise_to [get_clocks {Clk199Mhz}]  0.160  
set_clock_uncertainty -fall_from [get_clocks {CLK108Mhz}] -fall_to [get_clocks {Clk199Mhz}]  0.160  
...
# Set Output Delay
#**************************************************************
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[11]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[12]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[13]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[14]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[15]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[16]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[17]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[18]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[19]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[20]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[21]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[22]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[23]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[24]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[25]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[26]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[27]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[28]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[29]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[30]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_A_io[31]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[11]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[12]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[13]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[14]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[15]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[16]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[17]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[18]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[19]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[20]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[21]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[22]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[23]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[24]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[25]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[26]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[27]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[28]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[29]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[30]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {CPU_D_io[31]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_BEn_o[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_BEn_o[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_BEn_o[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_BEn_o[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_CS0n_o}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_CS1n_o}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_OEn_o}]
set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {LOCAL_MEM_SRAM_WEn_o}]
...
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK108Mhz}]  1.000 [get_ports {VID_B_PIX_o[11]}]

set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[11]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[12]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[13]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[14]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[15]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[16]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[17]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[18]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_Addy_o[19]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[11]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[12]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[13]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[14]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[15]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[16]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[17]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[18]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[19]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[20]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[21]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[22]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[23]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[24]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[25]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[26]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[27]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[28]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[29]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[30]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_DQ_io[31]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_BEn_o[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_BEn_o[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_BEn_o[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_BEn_o[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_OEn_o}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_A_WEn_o}]
#VRAM BANK B  VRAM_A_DQ_io
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[11]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[12]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[13]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[14]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[15]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[16]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[17]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[18]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_Addy_o[19]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[4]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[5]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[6]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[7]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[8]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[9]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[10]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[11]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[12]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[13]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[14]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[15]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[16]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[17]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[18]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[19]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[20]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[21]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[22]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[23]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[24]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[25]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[26]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[27]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[28]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[29]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[30]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_DQ_io[31]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_BEn_o[0]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_BEn_o[1]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_BEn_o[2]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_BEn_o[3]}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_OEn_o}]
set_output_delay -add_delay  -clock [get_clocks {CLK66MHz}]  1.000 [get_ports {VRAM_B_WEn_o}]


#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[0]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[1]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[2]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[3]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[4]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[5]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[6]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_A_o[7]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[0]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[1]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[2]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[3]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[4]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[5]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[6]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[7]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[8]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[9]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[10]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[11]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[12]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[13]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[14]}]
#set_output_delay -add_delay  -clock [get_clocks {CLK33MHz}]  1.000 [get_ports {IO_D_io[15]}]
...
set_false_path  -from  [get_clocks {CLK99MHz}]  -to  [get_clocks {Clk199Mhz}]
...
set_false_path -from [get_keepers {*rdptr_g*}] -to [get_keepers {*ws_dgrp|dffpipe_kd9:dffpipe12|dffe13a*}]
...
set_false_path -from [get_keepers {*rdptr_g*}] -to [get_keepers {*ws_dgrp|dffpipe_ve9:dffpipe10|dffe11a*}]
set_false_path -from [get_keepers {*delayed_wrptr_g*}] -to [get_keepers {*rs_dgwp|dffpipe_ue9:dffpipe7|dffe8a*}]
