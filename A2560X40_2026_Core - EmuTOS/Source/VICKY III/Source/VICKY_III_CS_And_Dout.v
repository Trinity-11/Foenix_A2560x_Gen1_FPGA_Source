...
input		wire					iBUS_CS_VICKY_MEM_A_i,	//C6
input		wire					iBUS_CS_VICKY_B_i,		//C8
input		wire					iBUS_CS_VICKY_MEM_B_i,	//CA
...
output	wire					CS_VIDEO_RAM_B0_o,
output	wire					CS_VIDEO_RAM_B1_o,
output	wire					CS_VDMA_Controller_B_o,
...
//		5'b0_0000: begin DataOut_A = DataOut_LPC_Interface_i; end
//		5'b0_0000: begin DataOut_A = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_A = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_A = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_A = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_A = DataOut_Math_Float_i; 	end
...
// Channel B - SDRAM
assign CS_VIDEO_RAM_B0_o 		= iBUS_CS_VRAM_A_i;
assign CS_VIDEO_RAM_B1_o 		= iBUS_CS_VRAM_B_i;


assign CS_VMEM_2_CPU_B_o 		= 1'b0;
assign CS_VDMA_Controller_B_o = 1'b0;

wire [4:0] CS_Combined_B;

assign CS_Combined_B 	= ( { CS_BG_CLUT_B_o,
										CS_BF_CLUT_B_o,
										CS_ColorMemory_B_o,
										CS_TextMemory_B_o,
										CS_VICKY_REG_B_o });
...
always @ (*) begin
	case (CS_Combined_B)
		...
		5'b0_0001: begin DataOut_B = VICKYIII_Reg_B_Dout_i; 	end
		5'b0_0010: begin DataOut_B = TextMemory_B_Dout_i; 		end
		5'b0_0100: begin DataOut_B = ColorMemory_B_Dout_i;		end
		5'b0_1000: begin DataOut_B = 32'h2222_3333;				end
		5'b1_0000: begin DataOut_B = 32'h6666_4444; 				end
//		5'b0_0000: begin DataOut_B = DataOut_IDE_ETH_DPS_i; 	end
//		5'b0_0000: begin DataOut_B = DataOut_Joystick_i; 		end
//		5'b0_0000: begin DataOut_B = DataOut_IDE_ETH_DPS_i; 	end
//		5'b0_0000: begin DataOut_B = DataOut_LPC_Interface_i; end
//		5'b0_0000: begin DataOut_B = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_B = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_B = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_B = DataOut_MathModule_i; 	end
//		5'b0_0000: begin DataOut_B = DataOut_Math_Float_i; 	end
