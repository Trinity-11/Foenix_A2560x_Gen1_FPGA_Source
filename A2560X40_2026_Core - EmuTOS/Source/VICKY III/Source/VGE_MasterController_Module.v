...
input		wire				VideoMuxClk_i,							// Full or Half Mode
input		wire				VideoClock_Full_Resolution_i,		// Always Full Mode, 25.175Mhz or 40Mhz
...
always @ (*)
begin
	case ({ Mstr_Ctrl_Doubling_Pixel_i, Mstr_Ctrl_Video_Mode_i[1:0] })
		3'b000: begin 
			// 640x480
			SX1 = 12'd704;
			SY1 = 12'd544;
