...
assign CS_Trinity_o				= ( iBUS_A_i[16:8] == 9'b0_0000_0101) & iBUS_CS_GABE_i;						// $FEC00500..$FEC005FF - JOYSTICK/JOYPAD
...
//assign CS_DMA_LPC_o				= (iBUS_A_i[16:10] == 7'b0_0020_01) & iBUS_CS_GABE_i;							// $FEC02400..$FEC027FF - DMA DP Memory 
// Math Block
...
assign CS_Combined 	= ( { CS_MATH_FLOAT_o, CS_MATH_FIXED_o, CS_LPC_o, CS_NIC_o, CS_Trinity_o, CS_IDE_o, CS_SDCard_o, CS_Timer_o, CS_Interrupt_Ctrl_o, CS_RTC_o, CS_A2560K_KB_o, CS_GABE_Config_o });

always @ (*) begin
	case (CS_Combined)
		12'b0000_0000_0000: begin DataOut_o = 32'hDEAD_BEEF; 					end
		12'b0000_0000_0001: begin DataOut_o = DataOut_GABE_Config_i; 		end		
		12'b0000_0000_0010: begin DataOut_o = 32'hC000_0000; 					end
		12'b0000_0000_0100: begin DataOut_o = DataOut_RTC_i; 					end
		12'b0000_0000_1000: begin DataOut_o = DataOut_Interrupt_Ctrl_i;	end
		12'b0000_0001_0000: begin DataOut_o = DataOut_Timer_i; 				end
		12'b0000_0010_0000: begin DataOut_o = DataOut_SDCARD_CTRL_i; 		end
		12'b0000_0100_0000: begin DataOut_o = DataOut_IDE_ETH_DPS_i; 		end
		12'b0000_1000_0000: begin DataOut_o = DataOut_Trinity_i; 			end
		12'b0001_0000_0000: begin DataOut_o = DataOut_IDE_ETH_DPS_i; 		end
		12'b0010_0000_0000: begin DataOut_o = DataOut_LPC_Interface_i;		end
		12'b0100_0000_0000: begin DataOut_o = DataOut_Math_Fixed_i; 		end
		12'b1000_0000_0000: begin DataOut_o = DataOut_Math_Float_i; 		end
