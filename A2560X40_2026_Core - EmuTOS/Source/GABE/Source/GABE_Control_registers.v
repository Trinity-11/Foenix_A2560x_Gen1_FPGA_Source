...
//localparam CPU_SPEED_ID = 3'b011,
//			  MACHINE_ID   = 4'b1000,
//			  CPU_ID       = 4'b0110;


localparam HW_REV_DIGIT0 = 8'h42, //A (ASCII)			  
			  HW_REV_DIGIT1 = 8'h30, //0 (ASCII)
			  HW_REV_DIGIT2 = 8'h41, //B (ASCII)
			  HW_DATE_YR   = 8'h22, //21  (Decimal)
			  HW_DATA_MT   = 8'h05, // Nov (Decimal)
			  HW_DATA_DY   = 8'h18; // 03 (Decimal)
			  

localparam 	FM_DATE_YR  = 8'h22, // 22 (Decimal)
				FM_DATE_MT  = 8'h06, // 01 (Decimal)
				FM_DATE_DY  = 8'h09; //
...
begin
	case(CPU_A_i[4:2])
		...
		3'b011: CPU_D_o = { CHIP_SUBVERSION[15:0], 4'b0110 ,4'b0000, 3'b011, 1'b0 , 4'b1000 };
