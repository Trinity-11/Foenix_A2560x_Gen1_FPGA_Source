...
//`define SLOW_SPI_CLK 8'h3b // 48Mhz
`define SLOW_SPI_CLK 8'h3d // 50Mhz
...
//`define TWO_MS 10'h177 // 48Mhz
`define TWO_MS 10'h186	// 50Mhz
// TWO_FIFTY_MS = ((250mS * spiSysClk) / 65536) - 1
//`define TWO_FIFTY_MS 12'h0b6 // 48Mhz
`define TWO_FIFTY_MS 12'h0be // 50Mhz
// ONE_HUNDRED_MS = ((100mS * spiSysClk) / 65536) - 1
//`define ONE_HUNDRED_MS 12'h048 // 48Mhz
`define ONE_HUNDRED_MS 12'h04B	// 50Mhz

`else //not SPI_SYS_CLK_48MHZ

`ifdef SPI_SYS_CLK_33MHZ
// --------------- spiSysClk = 33MHz
`define SLOW_SPI_CLK 8'h28
`define FAST_SPI_CLK 8'h00
`define TWO_MS 10'h103
`define TWO_FIFTY_MS 12'h07E
`define ONE_HUNDRED_MS 12'h032

`endif //SPI_SYS_CLK_33MHZ
