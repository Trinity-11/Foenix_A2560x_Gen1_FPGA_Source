...
// Unsigned Module Signals (68060 Signals)
input	wire					NEW_SIGN0,
input	wire					NEW_SIGN1,
input	wire					NEW_SIGN2,
input	wire					NEW_SIGN3,
input	wire					NEW_SIGN4,
input	wire					NEW_SIGN5,
input	wire					NEW_SIGN6,
...
// We are not using that Part Anymore
assign VClock_Slct_SYNC0n_o = 1'b1;
assign VClock_Slct_SYNC1n_o = 1'b1;
assign VClock_Slct_SCLK_o = 1'b0;
assign VClock_Slct_DIN_o = 1'b0;
...
BIDIR_SIGNAL	RESET_BUFFER (
	...
	.oe ( !SDCARD_RESET_i | !CPLD_COLD_RSTn_i | ( Timer_Reset_once != 32'h0000_0000) )	//| Manual_RESET
//	.oe ( ( Timer_Reset_once != 32'h0000_0000) )	//| Manual_RESET	
	);
...
GAVIN_A2560XEmuTOS_Top GABE_TOP_LEVEL(
// Reset
