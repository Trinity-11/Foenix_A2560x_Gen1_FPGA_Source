...
// Big Endian
assign Dbg_BEn[0] = !(CPU_Address[1:0] == 2'b11);
assign Dbg_BEn[1] = !(CPU_Address[1:0] == 2'b10);
assign Dbg_BEn[2] = !(CPU_Address[1:0] == 2'b01);
assign Dbg_BEn[3] = !(CPU_Address[1:0] == 2'b00);

assign Dbg_RAM_CS_o 	= Flash_Program_Mode ? Flash_Program_RAM_CSn  : ((Dbg_A_o[31:22]  == 10'b0000_0000_00) & CS_Trig); 	// $00:00000 - $3F:FFFF - 2Meg		// User RAM
assign Dbg_Flash_CS_o 	= Flash_Program_Mode ? Flash_Program_FLASH_CS : ((Dbg_A_o[31:22]  == 10'b1111_1111_11) & CS_Trig); 	// $FFC0:00000 - $FFFF:FFFF - 4Meg		// System FLASH/7			
// CPU SIDE
...
assign Dbg_BEn_o = Flash_Program_Mode ? 4'b0000 : Dbg_BEn[3:0];
