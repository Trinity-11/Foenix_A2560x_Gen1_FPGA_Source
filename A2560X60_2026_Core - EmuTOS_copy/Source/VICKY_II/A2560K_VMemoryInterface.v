...
// Video RAM Bank A
input		wire	[31:0]		VRAM_DQ_i,
output		reg		[31:0]		VRAM_DQ_o,
...
begin
	if ( Reset_100Mhz_i ) begin
		VRAM_DQ_o <= 32'h0000_0000;
	end
	else begin
		casex(Counter_Channel_i[2:0])
			3'b000: begin VRAM_DQ_o <= CPU_Data_2_Write; end
			3'b001: begin VRAM_DQ_o <= 32'h0000_0000; end
			3'b010: begin VRAM_DQ_o <= 32'h0000_0000; end
			3'b011: begin VRAM_DQ_o <= 32'h0000_0000; end			
			3'b1xx: begin VRAM_DQ_o <= {VDMA_Transaction_Data_i, VDMA_Transaction_Data_i, VDMA_Transaction_Data_i, VDMA_Transaction_Data_i}; end
		endcase
	end
end
...
always @ (posedge EngineClk100Mhz_i)
begin
	DataInputChannel0_o <= VRAM_DQ_i;
	DataInputChannel1_o <= VRAM_DQ_i;
	DataInputChannel2_o <= VRAM_DQ_i;
	DataInputChannel3_o <= VRAM_DQ_i;
//	DataInputChannel4_o <= VRAM_DQ_i;
end
...
begin
	case (VDMA_Src_Addy[1:0])
		2'b00: VDMA_Transaction_Data_o = VRAM_DQ_i[31:24];
		2'b01: VDMA_Transaction_Data_o = VRAM_DQ_i[7:0];
		2'b10: VDMA_Transaction_Data_o = VRAM_DQ_i[15:8]; 
		2'b11: VDMA_Transaction_Data_o = VRAM_DQ_i[23:16];
