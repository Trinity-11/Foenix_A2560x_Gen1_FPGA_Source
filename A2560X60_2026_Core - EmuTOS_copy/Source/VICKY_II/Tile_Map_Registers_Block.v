...
output	wire				Layer0Mode8_16_o,
output	wire				Layer1Mode8_16_o,
output	wire				Layer2Mode8_16_o,
output	wire				Layer3Mode8_16_o
...
assign 	Layer0Mode8_16_o = TILE_REG[0][4];
assign	Layer1Mode8_16_o = TILE_REG[4][4];
assign	Layer2Mode8_16_o = TILE_REG[8][4];
assign	Layer3Mode8_16_o = TILE_REG[12][4];
...
always @ (posedge EngineClk200Mhz_i) begin
	TILEMAP0_X_WIN_SCROLL_200_REG[0] <= {TILE_REG[3][15], TILE_REG[3][3:0]};
	...
	TILEMAP1_X_WIN_SCROLL_200_REG[0] <= {TILE_REG[7][15], TILE_REG[7][3:0]};
	...
	TILEMAP2_X_WIN_SCROLL_200_REG[0] <= {TILE_REG[11][15], TILE_REG[11][3:0]};
	...
	TILEMAP3_X_WIN_SCROLL_200_REG[0] <= {TILE_REG[15][15], TILE_REG[15][3:0]};		// Sign + Direction
